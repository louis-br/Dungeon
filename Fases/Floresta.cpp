...
void Floresta::criarTerreno() {
    ...
    new Plataforma(sf::Vector2f(2200, 190), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    new Plataforma(sf::Vector2f(2500, 160), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    new Plataforma(sf::Vector2f(2800, 130), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    new Plataforma(sf::Vector2f(3100, 100), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    ...
    new Plataforma(sf::Vector2f(4500, 330), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    new Plataforma(sf::Vector2f(4800, 330), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    new Plataforma(sf::Vector2f(5100, 330), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    new Plataforma(sf::Vector2f(5400, 330), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    ...
    new Plataforma(sf::Vector2f(8400, 240), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    new Plataforma(sf::Vector2f(8700, 200), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    new Plataforma(sf::Vector2f(9000, 160), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
    new Plataforma(sf::Vector2f(9300, 120), sf::Vector2f(148, 75), &listaEntidade, GerenciadorGrafico::PlataformaGrama);
